...
"""
function initial_condition_small_sedov_self_gravity(x, t, equations::CompressibleEulerEquations3D)
    ...
    r0 = 0.125 # = 4.0 * smallest dx (for domain length=2 and max-ref=6)
    E = 1.0
    ...
    r_ini = 0.5   # center point of function
...
function initial_condition_small_sedov_self_gravity(x, t,
...
function elixir_small_sedovblastwave_3d(; initial_refinement_level = 2,
   ...
   initial_condition = initial_condition_small_sedov_self_gravity
